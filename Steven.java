      ...
      case 0x6: // ALU ................... 6-sd
        switch (insOp0.get()) {
          case 0x0: // mov rs, rd ........ 60sd
               reg.set (insOp2.get(), reg.get (insOp1.get()));   // TODO
            break;
          case 0x1: // add rs, rd ........ 61sd
                  reg.set(insOp2.get(),reg.get(insOp1.get()) + reg.get(insOp2.get()));// TODO
            break;
          case 0x2: // and rs, rd ........ 62sd
                  reg.set (insOp2.get(), reg.get(insOp1.get()) & reg.get (insOp2.get()));// TODO
            break;
          case 0x3: // inc rr ............ 63-r
                  reg.set (insOp2.get(), reg.get(insOp2.get()) + 1);// TODO
            break;
          case 0x4: // inca rr ........... 64-r
              reg.set (insOp2.get(), reg.get(insOp2.get()) + 4);// TODO
            break;
          ...
          case 0x6: // deca rr ........... 66-r
            ...
            break;
          case 0x7: // not ............... 67-r
              reg.set (insOp2.get(), (~ reg.get(insOp2.get())));// TODO
            break;
          default:
